...
segment .data 
	bienvenida db "bienvenidos a la calculadora de assembler", 0xA,0xD
	tama1 equ $- bienvenida 
	msg1 db "ingrese un numero", 0xA,0xD
	len1 equ $- msg1 
	msg2 db "ingrese el numeroque hara las 4 operaciones al primer numero ", 0xA,0xD
	len2 equ $- msg2 
	...
	len5 equ $- msg5 
	msg6 db  0xA,0xD,"la mitad del numero es: "
	len6 equ $- msg6
...
;--------------------<suma>----------------------------------
	...
	cmp eax, 2 ;compara si ecx con cero 
...
;--------------------<division>----------------------------------
	...
	je  escero  ;si ecx es igual cero, entonces salta a escero
